...
const messages = useState<
  { id: number; user: string; message: string; created_at: string }[]
>(() => []);
...
<template>
  <div class="h-screen flex flex-col justify-between">
    <main>
      ...
      <div
        id="messages"
        class="flex-grow flex flex-col justify-end px-4 pt-8 pb-21 sm:pb-12 bg-slate-900 min-h-screen"
      >
        <div
      ...
      <!-- Chatbox -->
      <div
        class="bg-gray-800 px-4 py-2 flex items-center justify-between fixed bottom-0 w-full flex-col sm:flex-row"
      >
